 ...
 */
class CertificadoVehiculoVTVVO extends Master2 {
	public $idCertificadoVehiculoVTV = ["valor" => "",
       "obligatorio" => FALSE,
       "tipo" => "integer",
       "nombre" => "ID",
	];
	...
	public $archivo = ["valor" => "",
		...
		"tipo" => "string",
		"nombre" => "archivo",
		"ruta" => "vehiculos/certificadosVehiculoVTV/", // de files/ en adelante
	...
	public function __construct()
	{
		...
		$this->setTableName('CertificadosVehiculosVTV');
		$this->setFieldIdName('idCertificadoVehiculoVTV');
	...
	public function getCertificadosVehiculoVTVProximosAVencer() {
...
// debug zone
if($_GET['debug'] == 'CertificadoVehiculoVTVVO' or false){
	echo "DEBUG<br>";
	$kk = new CertificadoVehiculoVTVVO();
	//print_r($kk->getAllRows());
	$kk->idCertificadoVehiculoVTV = 116;
	$kk->usuario = 'hhh2';
