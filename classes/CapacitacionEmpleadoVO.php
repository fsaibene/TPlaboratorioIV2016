 ...
 * @created 23-ene-2015
 */
class CapacitacionEmpleadoVO extends Master2 {
    public $idCapacitacionEmpleado = ["valor" => "",
                       "obligatorio" => FALSE, 
                       "tipo" => "integer",
                       "nombre" => "id",
	...
	public function __construct()
	{
		...
		$this->setTableName('capacitaciones_empleados');
		$this->setFieldIdName('idCapacitacionEmpleado');
...
if($_GET['debug'] == 'CapacitacionEmpleadoVO' or false){
	echo "DEBUG<br>";
	$kk = new Establecimiento_TipoEstablecimientoVO();
	//print_r($kk->getAllRows());
	$kk->idCapacitacionEmpleado = 116;
	$kk->usuario = 'hhh2';
