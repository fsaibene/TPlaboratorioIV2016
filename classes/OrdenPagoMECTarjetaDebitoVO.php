 ...
 * @created 23-ene-2015
 */
class OrdenPagoMECTarjetaDebitoVO extends Master2 {
    public $idOrdenPagoMECTarjetaDebito = ["valor" => "",
                       "obligatorio" => FALSE, 
                       "tipo" => "integer",
                       "nombre" => "id",
	...
	public function __construct(){
        ...
        $this->setTableName('ordenesPagoMEC_tarjetasDebito');
		$this->setFieldIdName('idOrdenPagoMECTarjetaDebito');
