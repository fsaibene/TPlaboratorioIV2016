 ...
 */
class ActaTareaDiariaProyectoExternoVO extends Master2 {
    public $idActaTareaDiariaProyectoExterno = ["valor" => "",
        "obligatorio" => FALSE,
        "tipo" => "integer",
        "nombre" => "ID",
    ];
    ...
    public function __construct(){
        ...
        $this->setTableName('actaTareasDiaria_proyectosExternos');
        $this->setFieldIdName('idActaTareaDiariaProyectoExterno');
